...
app.get(['/health', '/health/live'], createLivenessHandler('catalog-service'));
app.get(['/ready', '/health/ready'], createReadinessHandler({ serviceName: 'catalog-service', isRedisCritical: false }));
