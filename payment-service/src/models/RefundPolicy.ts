...
const RefundPolicySchema: Schema = new Schema(
  {
    ...
    earlyCancellationHours: { type: Number, required: true, default: 2 },
    refundPercentage: { type: Number, required: true, default: 100 },
    providerCompensation: { type: Number, required: true, default: 100 },
