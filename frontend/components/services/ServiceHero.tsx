            ...
            <div className="relative flex items-center">
              ...
              >
                ...
                <motion.button
                  ...
                  className={`flex items-center justify-center px-5 py-2.5 rounded-full text-xs font-black transition-all border duration-300 whitespace-nowrap cursor-pointer shadow-sm ${
                    activeCategory === "all"
                ...
                {categories.map((category) => {
                  ...
                  return (
                    <motion.button
                      ...
                      className={`flex items-center justify-center gap-2 px-5 py-2.5 rounded-full text-xs font-black transition-all border duration-300 whitespace-nowrap cursor-pointer shadow-sm ${
                        isActive
                          ? "bg-[#1D2B83] text-white border-[#1D2B83] shadow-md shadow-[#1D2B83]/20"
                          : "bg-white text-slate-600 border-slate-200 hover:border-[#1D2B83] hover:text-[#1D2B83]"
                      }`}
                      ...
                      {category.icon && (
                        <img 
                          ...
                          className={`w-4.5 h-4.5 object-contain transition-all duration-300 ${
                            isActive ? "brightness-0 invert" : "opacity-85"
                          }`}
                        />
                      )}
